...
public class HiddenTag extends YanelTag {
    private static Logger log = Logger.getLogger(HiddenTag.class);
    ...
    public void doTag(XMLOutput out) throws MissingAttributeException, JellyTagException {
        try {
            ...
            attributes.addAttribute(XHTML_NAMESPACE, "", "type", "CDATA", "hidden");
