 ...
 */
public class KonakartProductJDBCNode extends org.wyona.yarep.impl.AbstractNode {
    private static Logger log = Logger.getLogger(KonakartProductJDBCNode.class);
    
    public KonakartProductJDBCNode(Repository repo, String path, String uuid) throws RepositoryException {
